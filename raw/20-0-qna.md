...
<figure><img src=".gitbook/assets/Q&#x26;A.jpg" alt="" width="375"><figcaption><p>Bring them on!</p></figcaption></figure>
...
But this gives me hope that such efforts could turn into a movement some day.

### E) Are you just putting old wine in a new bottle? <a href="#t4hou2ql383k" id="t4hou2ql383k"></a>
...
### F) Why do you keep talking about engineering? Don’t most books of this type talk just about science or philosophy? <a href="#bl6sx18aay7w" id="bl6sx18aay7w"></a>

It is true that most other books of this type talk only about science or philosophy, rarely engineering.

Of course, science and engineering are joined at the hip, with a lot of overlap. But I would like to point out a few things that are different about engineering and how they make a big difference to the MSE Framework.

The simplest reason for talking about engineering is that I am focused on finding a practical solution to the meaning crisis, which, as I have explained earlier, is a real and pressing problem for the world as well as for myself. Finding practical solutions to real world problems is the domain of engineering. Science only helps us understand the rules of the game, that too only to the level possible, but engineering is where the game actually gets played.

The deeper reason is that engineering is better at dealing with complexity, nebulosity and unknowns in reality than science. Science deals with clean abstractions, not messy reality.

This isn't so much a weakness of science, but a difference in their objectives and methods.
...
Of course, you might say, we can add that methodology to science. But then it would be no different from engineering, so the question becomes moot.
...
I have already covered this objection in a [Deep Dive into Gödel's Incompleteness Theorem](04-methodology.md#deep-dive-goedels-incompleteness-theorem) in the chapter on Methodology.
...
### I) How is the MSE Framework different from Effective Accelerationism (e/acc)? <a href="#o5wk6llj14dv" id="o5wk6llj14dv"></a>
...
### J) How is the MSE Framework different from the Omega Point concept? <a href="#id-9u3fx2wqdvwf" id="id-9u3fx2wqdvwf"></a>
...
### K) How does the MSE Framework relate to Spinoza’s idea of God? <a href="#ejm5s9flw6s0" id="ejm5s9flw6s0"></a>
...
### L) How does the MSE Framework relate to the Hindu / Vedic philosophy of Brahman? <a href="#id-3ugwkjz5a91" id="id-3ugwkjz5a91"></a>
...
### M) How does the MSE Framework relate to Buddhism? <a href="#id-9tradtxroxmm" id="id-9tradtxroxmm"></a>
...
### N) What is LifeVisor? <a href="#z2598opt491e" id="z2598opt491e"></a>
...
The idea is still evolving in my mind, and as it starts to materialize, you will be able to view at at the main project site: https://LifeVisor.ai.

You can also sign up for the mailing list on that page so you can be notified when things start to happen.

### O) I still have questions. How do I send them to you? How do I contact you in general? <a href="#z2598opt491e" id="z2598opt491e"></a>
